$(document).ready(function(){  
    ...
    //Loading - Added 02/05/2015
    $.mpb("show",{value: [0,50],speed: 5, state: 'warning'});
    ...
    $(".panel-refresh").on("click",function(){
        ...
        setTimeout(function(){
            ...
            $('#table-sync').load(curr_url + ' #table-sync' , function() {
                oTable = $('#export_csv').dataTable({
                    "oLanguage": {
...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="img/table-loader.gif"/></div>');
...
function x_navigation_minimize(action){
    ...
    if(action == 'open'){
        $(".page-container").removeClass("page-container-wide");
        $(".page-sidebar .x-navigation").removeClass("x-navigation-minimized");
        $(".x-navigation-minimize").find(".fa").removeClass("fa-plus-square").addClass("fa-minus-square");
    ...
    if(action == 'close'){
        ...
        $(".x-navigation-minimize").find(".fa").removeClass("fa-minus-square").addClass("fa-plus-square");
